...
public class Elements {
    ...
    public final static String AQUA_IMAGE_ASSET_SET_ID = "aquaImageAssetSetId";

    public final static String FLORA_ID = "flora";
    public final static String FLORA_NAME = "Flora";
    public final static String FLORA_IMAGE_ASSET_SET_ID = "floraImageAssetSetId";

    public final static String AERO_ID = "aero";
